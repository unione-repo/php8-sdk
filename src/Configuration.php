...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.unione.io/en/transactional/api/v1';
    ...
    {
        $this->host = 'https://' . $host . '/transactional/api/v1';
        return $this;
    }
    ...
    {
        $report  = 'PHP SDK (UniOne) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.76' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://api.unione.io/en/transactional/api/v1",
                "description" => "UniOne API-server instance",
            ]
        ];
    }
