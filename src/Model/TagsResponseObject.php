...
/**
 * TagsResponseObject Class Doc Comment
 *
 * @description An object with the properties of the user tags.
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class TagsResponseObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TagsResponseObject';
