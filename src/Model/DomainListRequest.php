...
/**
 * DomainListRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DomainListRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domain_list_request';
    ...
    */
     ...
     * Sets domain
     *
     * @param string|null $domain Optional domain name if you want to get the status of single domain only.
     *
     * @return $this
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Limits the number of domains returned. Default is 50.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int|null $offset Index of the first domain in the list, starting with 0.
     *
     * @return $this
     */
