...
/**
 * UnsubscribedListRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UnsubscribedListRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'unsubscribed_list_request';
    ...
    */
     ...
     * Sets dateFrom
     *
     * @param string|null $dateFrom Date in the format YYYY-MM-DD to get all unsubscribed emails from the **date_from** to the present day. If the parameter is not specified, the default period is today (from 00:00 UTC).
     *
     * @return $this
     */
