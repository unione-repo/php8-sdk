...
/**
 * InlineAttachmentsArrayInner Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InlineAttachmentsArrayInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InlineAttachmentsArray_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Attachment content id. For example, **name**=**IMAGECID1** should be referenced in HTML like <img src=**cid:IMAGECID1**>.
     *
     * @return $this
     */
