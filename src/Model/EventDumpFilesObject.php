...
/**
 * EventDumpFilesObject Class Doc Comment
 *
 * @description An object with the properties of the event dump file.
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class EventDumpFilesObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EventDumpFilesObject';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Use this unique URL to download the requested dump file (either .csv or .csv.gz, depending on your request).
     *
     * @return $this
     */
