...
/**
 * AttachmentsArrayInner Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AttachmentsArrayInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttachmentsArray_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Attachment type, see [MIME](https://en.wikipedia.org/wiki/MIME). If unsure, use **application/octet-stream**.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Attachment name in the format: **name.extension**. When multiple attachments are passed, their names must be unique. The symbol ‘/’ is not allowed in attachment names.
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param string $content File contents in [base64](https://en.wikipedia.org/wiki/Base64). Maximum file size 7MB (9786710 bytes in base64).
     *
     * @return $this
     */
