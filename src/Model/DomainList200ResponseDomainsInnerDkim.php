...
/**
 * DomainList200ResponseDomainsInnerDkim Class Doc Comment
 *
 * @description Object describing DKIM record value and status.
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class DomainList200ResponseDomainsInnerDkim implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domain_list_200_response_domains_inner_dkim';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key DKIM signature for the domain. This property contains only the key part, you should prepend it with **k=rsa, p=** part for the record to be valid (see [domain/get-dns-records](https://docs.unione.io/en/web-api-ref#domain-get-dns-records)).
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Only domains with **active** DKIM record are allowed as sender domains.
     *
     * @return $this
     */
