...
/**
 * SuppressionDeleteRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SuppressionDeleteRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'suppression_delete_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email An email to delete from suppression list.
     *
     * @return $this
     */
