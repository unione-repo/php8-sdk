...
/**
 * SuppressionSetRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SuppressionSetRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'suppression_set_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Email to add in suppression list.
     *
     * @return $this
     */
     ...
     * Sets created
     *
     * @param string|null $created When suppression was created, in UTC timezone in **YYYY-MM-DD hh:mm:ss** format.
     *
     * @return $this
     */
