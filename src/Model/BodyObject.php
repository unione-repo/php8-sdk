...
/**
 * BodyObject Class Doc Comment
 *
 * @description Contains HTML/plaintext/AMP parts of the email. Either html or plaintext part is required.
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class BodyObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BodyObject';
    ...
    */
     ...
     * Sets html
     *
     * @param string|null $html HTML part of the email body
     *
     * @return $this
     */
     ...
     * Sets plaintext
     *
     * @param string|null $plaintext Plaintext part of the email body.
     *
     * @return $this
     */
     ...
     * Sets amp
     *
     * @param string|null $amp Optional [AMP](http://amp.dev/documentation/guides-and-tutorials/learn/email_fundamentals/) part of the email body.
     *
     * @return $this
     */
    public function setAmp(?string $amp): static
    {
        if (is_null($amp)) {
