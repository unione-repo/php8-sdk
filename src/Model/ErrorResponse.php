...
class ErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param string $status **error** string
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message Human-readable error message in English.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param int $code [API Error code](https://docs.unione.io/en/web-api-ref#api-errors).
     *
     * @return $this
     */
