...
/**
 * TemplateListRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TemplateListRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'template_list_request';
    ...
    */
     ...
     * Sets limit
     *
     * @param int|null $limit Limits the number of templates returned, default is 50.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int|null $offset Index of the first template in the list, starting with 0.
     *
     * @return $this
     */
