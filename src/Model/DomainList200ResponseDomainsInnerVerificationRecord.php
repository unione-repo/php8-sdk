<?php
/**
 * DomainList200ResponseDomainsInnerVerificationRecord
 *
 * PHP version 8.1
 *
 * @package  UniOne
...
/**
 * DomainList200ResponseDomainsInnerVerificationRecord Class Doc Comment
 *
 * @description Object describing verification record value and status.
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class DomainList200ResponseDomainsInnerVerificationRecord implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domain_list_200_response_domains_inner_verification_record';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Record to be added **as is** to verify ownership of this domain.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Only domains with **confirmed** verification record are allowed as sender domains.
     *
     * @return $this
     */
