...
/**
 * EmailSubscribeRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EmailSubscribeRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'email_subscribe_request';
    ...
    */
     ...
     * Sets fromEmail
     *
     * @param string $fromEmail Sender’s email. (Field alias **email_address_from** is supported, too).
     *
     * @return $this
     */
     ...
     * Sets fromName
     *
     * @param string $fromName Sender’s name. (Field alias **name_from** is supported, too).
     *
     * @return $this
     */
     ...
     * Sets toEmail
     *
     * @param string $toEmail Recipient’s email. (Field alias **email_address_to** is supported, too).
     *
     * @return $this
     */
