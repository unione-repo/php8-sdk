...
/**
 * WebhookListRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class WebhookListRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'webhook_list_request';
    ...
    */
     ...
     * Sets limit
     *
     * @param int|null $limit Limits the number of webhooks returned. 50 is recommended.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int|null $offset Index of the first webhook in the list, starting with 0.
     *
     * @return $this
     */
