...
/**
 * EventDumpGetRequest Class Doc Comment
 *
 * @package  UniOne
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EventDumpGetRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'event_dump_get_request';
    ...
    */
     ...
     * Sets dumpId
     *
     * @param string $dumpId Dump identifier received by the method [event-dump/create](https://docs.unione.io/en/web-api-ref#event-dump-create).
     *
     * @return $this
     */
