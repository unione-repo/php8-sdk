...
------------ | ------------- | ------------- | ------------- | ------------- | -------------
**id** | **string** | Template unique identifier. If you omit the **id** field then new template will be created. If you specify the **id** field, the system will try to find a template with the specified id and edit it. | | null | 
...
**body** | [**\UniOne\Model\BodyObject**](BodyObject.md) |  | | null | 
